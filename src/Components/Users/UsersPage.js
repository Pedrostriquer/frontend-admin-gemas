      ...
      >
        ...
        <div style={styles.createUserGrid}>
          ...
          <div style={styles.permissionsColumn}>
            ...
            <div style={styles.permissionGroup}>
              <h5 style={styles.permissionGroupH5}>Contratos</h5>
              <div style={styles.permissionButtons}>
                {allPermissions.contracts
            ...
            <div style={styles.permissionGroup}>
              <h5 style={styles.permissionGroupH5}>E-commerce</h5>
              <div style={styles.permissionButtons}>
                {allPermissions.ecommerce
                  .filter((p) => !selectedPermissions.has(p))
                  .map((p) => (
                    <button
                      key={p}
            ...
            <div style={styles.permissionGroup}>
              <h5 style={styles.permissionGroupH5}>Sistema</h5>
              <div style={styles.permissionButtons}>
...
function UsersPage() {
  ...
  return (
    <div style={styles.usersPageContainer}>
      ...
      {modal.type === "create" && (
        <CreateUserModal onClose={handleCloseModal} isClosing={isClosing} />
      )}
    </div>
  );
}
