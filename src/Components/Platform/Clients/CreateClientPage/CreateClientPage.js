    ...
    <div style={styles.progressBarContainer}>
      ...
      {steps.map((label, index) => (
        <div key={index} style={styles.progressStep}>
          ...
          <div style={styles.progressLabel(index + 1 === currentStep)}>
            {label}
          </div>
        </div>
      ))}
...
export default function CreateClientPage() {
  ...
  const validateStep = (currentStep) => {
    if (currentStep === 1) {
      if (
        ...
        return "Preencha os campos de dados pessoais.";
    }
    if (currentStep === 2) {
      if (
        !formData.cep ||
  ...
  const handleFinalSubmit = async (e) => {
    ...
    try {
      ...
      const apiError =
        err?.response?.data || err.message || "Ocorreu um erro no cadastro.";
      setError(apiError);
    } finally {
      setLoading(false);
      stopLoading();
        ...
        <form onSubmit={handleFinalSubmit} noValidate>
          ...
          {step === 1 && (
            <>
              ...
              <div style={styles.formRow}>
                <div style={styles.formField}>
                  <label style={styles.label}>Contato (com DDD)</label>
                  <input
                    name="phoneNumber"
                ...
                <div style={styles.formField}>
                  <label style={styles.label}>Profissão (Opcional)</label>
                  <input
                    name="jobTitle"
                    style={styles.input}
          ...
          {step === 2 && (
            <>
              ...
              <div style={styles.formRow}>
                <div style={{ ...styles.formField, flex: 0.3 }}>
              ...
              <div style={styles.formRow}>
                ...
                <div style={{ ...styles.formField, flex: 0.4 }}>
          ...
          <div style={styles.formNavigation}>
            {step > 1 ? (
              <button type="button" style={styles.navButton} onClick={prevStep}>
                Voltar
              </button>
            ) : (
              <div></div>
